...
import { User, Campaign, Lead } from '../../types/dashboard';
...
export default function DashboardPage() {
  ...
  const [campaigns] = useState<Campaign[]>([
    ...
    {
      id: '2',
      name: 'Real Estate Agents in Berlin',
      leadsCount: 89,
      emailsSent: 67,
      openRate: 65.2,
      replyRate: 8.9,
  ...
  const [leads] = useState<Lead[]>([
    {
      id: '1',
      name: 'Dr. Anna Novak',
      company: 'Dental Care Prague',
      industry: 'Healthcare',
      location: 'Prague, Czech Republic',
      email: 'anna@dentalcare.cz',
      rating: 4.8,
      selected: false
    },
    {
      id: '2',
      name: 'Dr. Petr Svoboda',
      company: 'Smile Dental Clinic',
      industry: 'Healthcare',
      location: 'Prague, Czech Republic',
      email: 'petr@smiledental.cz',
      rating: 4.6,
      selected: false
    },
    {
      id: '3',
      name: 'Dr. Maria Kovač',
      company: 'Modern Dentistry',
      industry: 'Healthcare',
      location: 'Prague, Czech Republic',
      email: 'maria@moderndentistry.cz',
      rating: 4.9,
      selected: false
    }
  ]);
